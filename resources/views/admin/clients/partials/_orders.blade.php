<div class="row">
    <div class="table-responsive mb-4 mt-4">
        <table id="userOrders" class="table table-hover non-hover" style="width:100%">
            <thead>
            <tr>
                <th></th>
                <th>رقم الطلب</th>
            ...
            <tbody>
            @foreach($client->orders()->where('is_fast',0)->get() as $item)
                <tr>
                    <td>{{$item['id']}}</td>
...
@section('js')
    <x-datatable id="userOrders" mass="{{route('admin.order.mass.destroy')}}"></x-datatable>
@endsection
