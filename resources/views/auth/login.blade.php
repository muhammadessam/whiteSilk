        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    <h2 class="">سجل دخولك الي <a href="{{route('admin.home')}}"><span class="brand-name">White Silk</span></a></h2>
                    <form class="text-left" action="{{route('login')}}" method="post">
                        ...
                        <div class="form">
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="username" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus type="text" class="form-control" placeholder="البريد الالكتروني">
                            ...
                            <div class="d-sm-flex justify-content-between">
                                <div class="field-wrapper toggle-pass">
                                    ...
                                    <p class="d-inline-block">اظهر كلمة المرور</p>
                                </div>
                            ...
                            <div class="field-wrapper">
                                <a href="auth_pass_recovery.html" class="forgot-pass-link">نسيت كلمة السر؟</a>
                            </div>
